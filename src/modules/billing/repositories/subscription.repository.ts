...
import { Prisma, Subscription } from '../../../../prisma/generated/prisma/index';
...
export class SubscriptionRepository {
    ...
    async update(protocolId: string, data: Prisma.SubscriptionUpdateInput): Promise<Subscription> {
    ...
    async upsert(protocolId: string, data: Prisma.SubscriptionCreateInput | Prisma.SubscriptionUncheckedCreateInput): Promise<Subscription> {
    ...
    async findExpired(): Promise<(Subscription & { protocol: { protocolPubkey: string } })[]> {
    ...
    async findDueForReset(): Promise<(Subscription & { protocol: { protocolPubkey: string } })[]> {
        return this.prisma.subscription.findMany({
            where: {
                status: 'active',
