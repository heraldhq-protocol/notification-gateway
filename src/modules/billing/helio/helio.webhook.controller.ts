import { Controller, Post, Req, Body, Headers, HttpCode, HttpStatus, UseGuards } from '@nestjs/common';
...
export class HelioWebhookController {
    ...
    async handleWebhook(
        ...
        const protocolId = await this.protocolService.findIdByPubkey(protocolPubkey);
        ...
        await this.webhookQueue.add('process-helio-event', {
