-- Sync: telegram custom bot token + pending connections (gateway-owned tables).
-- Added by gateway migration 20260530000000_add_telegram_bot_token_and_pending_connections.
